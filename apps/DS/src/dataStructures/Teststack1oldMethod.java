...
public class Teststack1oldMethod extends TestCase 
{	   private intStackRetObjectArray numbers;   private intStackRetObjectArray otherNumbers;   
	
   public Teststack1oldMethod(String name) {
      super(name);
   }
   ...
   */
   {
      ...
      TestSuite suite = new TestSuite(Teststack1oldMethod.class);
   ...
   */
      String[] testCaseName = {Teststack1oldMethod.class.getName()};
