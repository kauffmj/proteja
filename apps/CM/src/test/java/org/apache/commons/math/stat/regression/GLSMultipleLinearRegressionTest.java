...
public class GLSMultipleLinearRegressionTest extends MultipleLinearRegressionAbstractTest {
    ...
    public void testCannotAddXSampleData() {
        createRegression().newSampleData(new double[]{}, null, null);
    }

    @Test(expected=IllegalArgumentException.class)
    public void testCannotAddNullYSampleData() {
        createRegression().newSampleData(null, new double[][]{}, null);
    }

    @Test(expected=IllegalArgumentException.class)
    public void testCannotAddSampleDataWithSizeMismatch() {
    ...
    @Test(expected=IllegalArgumentException.class)
    public void testCannotAddNullCovarianceData() {
    ...
    @Test(expected=IllegalArgumentException.class)
    public void testCannotAddCovarianceDataWithSampleSizeMismatch() {
        double[] y = new double[]{1.0, 2.0};
    ...
    @Test(expected=IllegalArgumentException.class)
    public void testCannotAddCovarianceDataThatIsNotSquare() {
        double[] y = new double[]{1.0, 2.0};
        double[][] x = new double[2][];
        x[0] = new double[]{1.0, 0};
        x[1] = new double[]{0, 1.0};
