...
public class AdamsMoultonIntegratorTest extends TestCase {

    /* ExpectsException @Test(expected=IntegratorException.class)
    public void testDimensionCheck() throws DerivativeException, IntegratorException {
    ...
    /* ExpectsException @Test(expected = DerivativeException.class)
    public void testExceedMaxEvaluations() throws DerivativeException, IntegratorException {
    ...
    @Test
    public void testPolynomial() throws DerivativeException, IntegratorException {
