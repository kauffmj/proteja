/*---------------------------------------------------------------------
 *  File: $Id: ExperimentBB.java,v 1.0 2007/07/02 13:36:17 smitha Exp $   
...
public class ExperimentBB
{

	public static void main(String[] args)throws IOException
	{
		final String DATA = "data/diatoms/reduce/xmlSetCovers/BB-setCover.xml";
		...
		File resultsFileHGS = new File("data/diatoms/reduce/xmlSetCoversResults/ExperimentBBResults_HGS.dat");
		File resultsFileDG = new File("data/diatoms/reduce/xmlSetCoversResults/ExperimentBBResults_DG.dat");
		File resultsFileG = new File("data/diatoms/reduce/xmlSetCoversResults/ExperimentBBResults_G.dat");
		File resultsFileKW = new File("data/diatoms/reduce/xmlSetCoversResults/ExperimentBBResults_KW.dat");
		...
		while (metricsIterator.hasNext())
		{
			...
			{			
				...
				if(i)
				{
					SetCover.saveSetCoverAsCoverageAndTimeFile(g,"data/diatoms/reduce/xmlSetCovers/BBCoverage.dat","data/diatoms/reduce/xmlSetCovers/BBTime.dat");
