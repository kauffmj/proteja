/*---------------------------------------------------------------------
 *  File: $Id: ExperimentSR.java,v 1.0 2007/07/02 13:36:17 smitha Exp $   
...
public class ExperimentSR
{

	public static void main(String[] args)throws IOException
	{
		final String DATA = "data/diatoms/reduce/xmlSetCovers/SR-setCover.xml";
		...
		File resultsFileHGS = new File("data/diatoms/reduce/xmlSetCoversResults/ExperimentSRResults_HGS.dat");
		File resultsFileDG = new File("data/diatoms/reduce/xmlSetCoversResults/ExperimentSRResults_DG.dat");
		File resultsFileG = new File("data/diatoms/reduce/xmlSetCoversResults/ExperimentSRResults_G.dat");
		File resultsFileKW = new File("data/diatoms/reduce/xmlSetCoversResults/ExperimentSRResults_KW.dat");
		...
		while (metricsIterator.hasNext())
		{
			...
			{			
				...
				if(i)
				{
					SetCover.saveSetCoverAsCoverageAndTimeFile(g,"data/diatoms/reduce/xmlSetCovers/SRCoverage.dat","data/diatoms/reduce/xmlSetCovers/SRTime.dat");
