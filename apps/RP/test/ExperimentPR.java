/*---------------------------------------------------------------------
 *  File: $Id: ExperimentPR.java,v 1.0 2007/07/02 13:36:17 smitha Exp $   
...
public class ExperimentPR
{

	public static void main(String[] args)throws IOException
	{
		final String DATA = "data/diatoms/reduce/xmlSetCovers/PR-setCover.xml";
		...
		File resultsFileHGS = new File("data/diatoms/reduce/xmlSetCoversResults/ExperimentPRResults_HGS.dat");
		File resultsFileDG = new File("data/diatoms/reduce/xmlSetCoversResults/ExperimentPRResults_DG.dat");
		File resultsFileG = new File("data/diatoms/reduce/xmlSetCoversResults/ExperimentPRResults_G.dat");
		File resultsFileKW = new File("data/diatoms/reduce/xmlSetCoversResults/ExperimentPRResults_KW.dat");
		...
		while (metricsIterator.hasNext())
		{
			...
			{			
				...
				if(i)
				{
					SetCover.saveSetCoverAsCoverageAndTimeFile(g,"data/diatoms/reduce/xmlSetCovers/PRCoverage.dat","data/diatoms/reduce/xmlSetCovers/PRTime.dat");
