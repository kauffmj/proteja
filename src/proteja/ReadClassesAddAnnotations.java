 ...
 * 
 * Reads the list of classes from settings.out and adds JUnit annotations to each of them using AnnotationAdderASM.
 * 
	...
	public static void main(String[] args)
	{
		...
		for(Class clazz : set.getTestClasses())
		{
            ...
            {		
			    ...
			    // run AnnotationAdder
			    proc = rt.exec("java proteja.AnnotationAdderASM " + clazz.getName() + " " + args[0], envp);
