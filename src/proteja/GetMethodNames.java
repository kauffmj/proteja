/** GetMethodNames.java
 * 
 *  Determines which methods need annotated and passes them along to the MethodAdapter 'AddAnnotations'.
 *
...
public class GetMethodNames extends ClassAdapter
{
	...
	{
   		if(name.equals("<init>") || name.equals("main") || name.equals("suite"))
			return false;
		else
			return true;
	}
